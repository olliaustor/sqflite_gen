...
/// Generates method get for table
class TableToMethodGetGenerator {
  ...
  Future<%className%?> get(%fieldType% %primaryColumnFieldName%) async {
    ...
    return maps.isEmpty
      ? null
      : %className%.fromMap(maps.first);
  }
''';

  /// Generates get method from given [CreateTableStatement]
  ///  'statement': table statement
  ///
  /// Returns [String] containing the get method
